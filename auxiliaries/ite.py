...
def iterator(target, headers, wordlist, body, proxies, filter_error, filter_size, delay, rate):
    url = target
    ...
    if "FUZZ" in body:
        post_it(target, wordlist, body, proxies, filter_error, filter_size, delay, rate)
    else:
